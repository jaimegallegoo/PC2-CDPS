...
def mv_docker_compose (version, ratings, star):
  ...
  subprocess.call(['sudo', 'docker', 'build', '--build-arg service_version=v1', '--build-arg enable_ratings=false', '-t', 'g27/reviews-v1', './practica_creativa2/bookinfo/src/reviews/reviews-wlpcfg'])
