...
def mv_docker_compose (version, ratings, star):
  ...
  subprocess.call(['sudo', 'docker', 'build', '-t', 'g27/reviews-v1:latest'])
  subprocess.call(['sudo', 'docker', 'build', '-t', 'g27/reviews-v2:latest'])
  subprocess.call(['sudo', 'docker', 'build', '-t', 'g27/reviews-v3:latest'])
