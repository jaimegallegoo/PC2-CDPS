...
def mv_docker_compose (version, ratings, star):
  ...
  subprocess.call(['sudo', 'docker', 'run', '--rm', '-u', 'root', '-v', f'{subprocess.run(['pwd'], capture_output=True, text=True).stdout.strip()}:/home/gradle/project', '-w', '/home/gradle/project', 'gradle:4.8.1', 'gradle', 'clean', 'build'])
